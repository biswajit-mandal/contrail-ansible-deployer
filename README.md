...
Please check [Enable/Disable Contrail Analytics Components](https://github.com/biswajit-mandal/contrail-ansible-deployer/blob/master/README.md#enable-diable-contrail-analytics-components) Section to enable these services.
